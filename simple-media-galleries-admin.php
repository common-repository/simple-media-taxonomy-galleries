...
/**
 *  Automatic Media Galleries Options
 */
...
class SimpleMediaGalleries {
	...
	public function __construct() {
        $defaults = array(
            "photo_category"=> '', "photo_tag"=>  '', "simple_media_taxonomies"=> '',
            "simple_media_template_output"=>  "post", "simple_media_gallery_bulk_edit"=> '',
	...
	public function simple_media_Galleries_add_plugin_page() {
		add_options_page(
			'Automatic Media Galleries', // page_title
			'Automatic Media Galleries', // menu_title
    ...
    ?>
		<div class="wrap">
			<h2>Automatic Media Galleries</h2>
			<p>This plugin should work with other media plugins. We recommend <a href='https://wordpress.org/plugins/media-library-assistant/'>Media Library Assistant</a> or <a href='https://wordpress.org/plugins/enhanced-media-library/'>Enhanced Media Library</a> </p>
			<p><i>Warning: This plugin may not function properly on a local development installation.</i></p>
	...
	public function simple_media_Galleries_page_init() {
		...
		add_settings_section(
			...
			'Virtual Automatic Gallery Settings', // title
        ...
        add_settings_field('simple_media_gallery_bulk_edit',
                        'Enable Bulk Editor. This feature enables  bulk editing of custom categories & tags in the media library. You should not enable this feature if you have a supporting media libary management plugin installed.',
	    ...
	    add_settings_field(
			    ...
			    'Auto Generate galleries as Pages or Posts?', // title
        ...
        add_settings_field(
			    ...
			    'Sub directory for single-post.php if not in the template directory of the theme or child theme (advanced users only).' , // title
	    ...
	    add_settings_section(
			...
			'Enable Custom Photo Categories and Tags', // title
    ...
    {
        echo 'Decide if virtual automatic galleries should be output as posts or pages:';
    }
	public function simple_media_Galleries_section_info() {
        echo "Select the taxonomies that will generate virtual galleries. There is no need to enable this if shortcode is going to be used. Virtual galleries create temporary posts that can not be edited";

	}
    public function simple_media_taxonomies_section_info()
    {
        echo "Enable custom photo categories and tags. You do not need these if this plugin is supporting one of the media library plugins like <a href='https://wordpress.org/plugins/media-library-assistant/'>Media Library Assistant</a> or <a href='https://wordpress.org/plugins/enhanced-media-library/'>Enhanced Media Library</a>.
        Select this option and save. The new photo categories and tags will appear in the Virtual Gallery Settings at the top of this page.";
    }
