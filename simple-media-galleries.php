<?php
/*
Plugin Name: Automatic Galleries
...
class simple_media_galleries
{
    ...
    function simple_media_galleries_taxonomy()
    {
			...
			'parent_item_colon' => 'Parent Photo Categories:',
